...
<html lang="en">
<head>
    <title>Code coverage report for src/templiteral.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> templiteral.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var templit = (function (exports) {
'use strict';
&nbsp;
...
class ContentNode {
  constructor(node, compiler) {
    ...
    this.base = node.nodeValue || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
...
&nbsp;
  addListener(eventName, method) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.eventMap.get(eventName)) {
      this.node.addEventListener(eventName, method.bind(this.context));
      this.eventMap.set(eventName, method);
      !this.context.DEBUG ? this.node.removeAttribute(`(${eventName})`) : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
    }
  }
&nbsp;
  disconnect() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.eventMap.size) {
  ...
  update(values) {
    this.boundAttrs.forEach(attribute =&gt; {
      ...
      if (attribute.name.match(propPattern)) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (attribute.baseIndicies.length === 1) {
...
const deepEqual = (a, b) =&gt; {
  ...
  if (a &amp;&amp; b &amp;&amp; typeof a == 'object' &amp;&amp; typeof b == 'object') {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (arrA &amp;&amp; arrB) {
      length = a.length;
      if (length != b.length) return false;
      for (i = length; i-- !== 0;)
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!deepEqual(a[i], b[i])) <span class="cstat-no" title="statement not covered" >return false;</span>
      return true;
    }
...
<span class="cstat-no" title="statement not covered" >    const dateA = a instanceof Date;</span>
<span class="cstat-no" title="statement not covered" >    const dateB = b instanceof Date;</span>
...
<span class="cstat-no" title="statement not covered" >    const regexpA = a instanceof RegExp;</span>
<span class="cstat-no" title="statement not covered" >    const regexpB = b instanceof RegExp;</span>
...
<span class="cstat-no" title="statement not covered" >    const keys = Object.keys(a);</span>
<span class="cstat-no" title="statement not covered" >    length = keys.length;</span>
        
<span class="cstat-no" title="statement not covered" >    if (length !== Object.keys(b).length) <span class="cstat-no" title="statement not covered" >return false;</span></span>
        
<span class="cstat-no" title="statement not covered" >    for (i = length; i-- !== 0;)</span>
<span class="cstat-no" title="statement not covered" >      if (!Object.hasOwnProperty.call(b, keys[i])) <span class="cstat-no" title="statement not covered" >return false;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (i = length; i-- !== 0;) {</span>
<span class="cstat-no" title="statement not covered" >      key = keys[i];</span>
<span class="cstat-no" title="statement not covered" >      if (!deepEqual(a[key], b[key])) <span class="cstat-no" title="statement not covered" >return false;</span></span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return true;</span>
  ...
  return a!==a &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >b!==b;</span>
};
&nbsp;
class DirectiveNode {
  ...
  init() {
    this.templates = this.values.map((value, index) =&gt; {
      ...
      if (this.templateMap === null) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof $$key !== 'string' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof $$key !== 'number')</span> {
<span class="cstat-no" title="statement not covered" >          this.templateMap = new WeakMap();</span>
        } else {
...
&nbsp;
    activeKeys.forEach(key =&gt; {
      previousKeys.has(key) ? null : <span class="branch-1 cbranch-no" title="branch not covered" >newKeys.add(key);</span>
    });
&nbsp;
...
&nbsp;
    if (this.location instanceof Comment) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.group) {
...
<span class="cstat-no" title="statement not covered" >            appendIndex -= 1;</span>
          }
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.context[rendererSymbol]) {
...
&nbsp;
  _createBase() {
    return this.strings.map((string, index) =&gt; {
      ...
      let output = '';
      output += string ? string : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
    ...
    this.observer = new MutationObserver(mutationsList =&gt; {
      mutationsList.forEach(mutation =&gt; {
        [...mutation.removedNodes].forEach(node =&gt; {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.adopters.has(node)) {
<span class="cstat-no" title="statement not covered" >            this.adopters.delete(node);</span>
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.adopters.has(node.shadowRoot)) {
<span class="cstat-no" title="statement not covered" >            this.adopters.delete(node.shadowRoot);</span>
          }
        });
      });
    });
...
&nbsp;
  adopt<span class="fstat-no" title="function not covered" >(node, name) {</span>
<span class="cstat-no" title="statement not covered" >    const fromNode = this.adopters.get(node) || new Map();</span>
<span class="cstat-no" title="statement not covered" >    if (!fromNode.size) {</span>
<span class="cstat-no" title="statement not covered" >      this.adopters.set(node, fromNode);</span>
    }
<span class="cstat-no" title="statement not covered" >    if (!fromNode.has(name) &amp;&amp; this.get(name) !== this._pending) {</span>
<span class="cstat-no" title="statement not covered" >      const sheet = this.get(name);</span>
<span class="cstat-no" title="statement not covered" >      node.appendChild(sheet);</span>
<span class="cstat-no" title="statement not covered" >      fromNode.set(name, sheet);</span>
<span class="cstat-no" title="statement not covered" >      return Promise.resolve(sheet);</span>
    } else <span class="cstat-no" title="statement not covered" >if (this.get(name) === this._pending) {</span>
<span class="cstat-no" title="statement not covered" >      return new Promise((resolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const interval = window.setInterval(() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          if (this.get(name)) {</span>
<span class="cstat-no" title="statement not covered" >            const sheet = this.get(name);</span>
<span class="cstat-no" title="statement not covered" >            if (sheet !== this._error &amp;&amp; sheet !== this._pending) {</span>
<span class="cstat-no" title="statement not covered" >              node.appendChild(sheet);</span>
<span class="cstat-no" title="statement not covered" >              fromNode.set(name, sheet);</span>
<span class="cstat-no" title="statement not covered" >              resolve(sheet);</span>
<span class="cstat-no" title="statement not covered" >              window.clearInterval(interval);</span>
            } else <span class="cstat-no" title="statement not covered" >if (sheet === this._error) {</span>
...
<span class="cstat-no" title="statement not covered" >      return Promise.resolve(fromNode.get(name));</span>
    }
  }
&nbsp;
  createSheet<span class="fstat-no" title="function not covered" >(textContent) {</span>
<span class="cstat-no" title="statement not covered" >    const sheet = document.createElement('style');</span>
<span class="cstat-no" title="statement not covered" >    sheet.textContent = textContent;</span>
<span class="cstat-no" title="statement not covered" >    return sheet;</span>
  }
&nbsp;
  define<span class="fstat-no" title="function not covered" >(name, value) {</span>
<span class="cstat-no" title="statement not covered" >    this.registry.set(name, value);</span>
<span class="cstat-no" title="statement not covered" >    return Promise.resolve({name});</span>
  }
&nbsp;
  get<span class="fstat-no" title="function not covered" >(name) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.registry.get(name)) {</span>
<span class="cstat-no" title="statement not covered" >      const cssText = this.registry.get(name);</span>
<span class="cstat-no" title="statement not covered" >      if (cssText === this._pending || cssText === this._error) {</span>
<span class="cstat-no" title="statement not covered" >        return cssText;</span>
      }
<span class="cstat-no" title="statement not covered" >      return this.createSheet(cssText);  </span>
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error(``)</span>
    }
  }
  
  load<span class="fstat-no" title="function not covered" >(name, url, config) {</span>
<span class="cstat-no" title="statement not covered" >    this.registry.set(name, this._pending);</span>
<span class="cstat-no" title="statement not covered" >    return fetch(url, config)</span>
      .then(response =&gt; <span class="cstat-no" title="statement not covered" >response.text())</span>
      .then(styleText =&gt; {
<span class="cstat-no" title="statement not covered" >        this.define(name, styleText);</span>
<span class="cstat-no" title="statement not covered" >        return name;</span>
      })
      .catch(error =&gt; {
<span class="cstat-no" title="statement not covered" >        this.define(name, this._error);</span>
      });
  }
}
&nbsp;
...
function templiteral(location = this, context = this) {
  location.shadowRoot ? <span class="branch-0 cbranch-no" title="branch not covered" >location = location.shadowRoot </span>: null;
&nbsp;
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (compiler) {
<span class="cstat-no" title="statement not covered" >      [...compiler.location.children].forEach(child =&gt; <span class="cstat-no" title="statement not covered" >compiler.location.removeChild(child))</span>;</span>
<span class="cstat-no" title="statement not covered" >      compiler = new Template(strings, values, location, context);</span>
<span class="cstat-no" title="statement not covered" >      templateCache.set(location, compiler);</span>
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function condition(bool) {</span>
<span class="cstat-no" title="statement not covered" >  return (strings, ...values) =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >    return bool ? [[strings, values]] : [[[], values]];</span>
  };
}
&nbsp;
class Component extends HTMLElement {
  static get styles() { return styleRegistry; }
  static get defineStyles<span class="fstat-no" title="function not covered" >() {</span> <span class="cstat-no" title="statement not covered" >return this.styles.define.bind(styleRegistry); </span>}
  static get hasStyles() { return this.styles.registry.has.bind(styleRegistry.registry); }
  static get loadStyles<span class="fstat-no" title="function not covered" >() {</span> <span class="cstat-no" title="statement not covered" >return this.styles.load.bind(styleRegistry); </span>}
    ...
    const stateProxy = watch(state, (target, property, descriptor) =&gt; {
      try {
        if (this.constructor.boundAttributes.includes(property)) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (descriptor.value === false || descriptor.value === null) {
<span class="cstat-no" title="statement not covered" >            this.removeAttribute(property);</span>
          } else {
    ...
    Object.defineProperty(this, 'state', {
      ...
      set(_state) {
        Object.keys(_state).forEach(key =&gt; {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof _state[key] !== 'string' || <span class="branch-1 cbranch-no" title="branch not covered" >typeof _state[key] !== 'number')</span> {
            state[key] = _state[key];
          } else {
<span class="cstat-no" title="statement not covered" >            state[key] = watch(_state[key], () =&gt; <span class="cstat-no" title="statement not covered" >this[this.constructor.renderer]())</span>;</span>
          }
        });
        return true;
      }
    ...
    this.constructor.boundAttributes.map((attr, index, currentArray) =&gt; {
      Object.defineProperty(this, attr, {
        ...
        set(_attr) {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (this.constructor.renderer &amp;&amp; typeof this[this.constructor.renderer] === 'function' &amp;&amp; this.isConnected &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >attrs.size === currentArray.length)</span> {
<span class="cstat-no" title="statement not covered" >            this[this.constructor.renderer]();</span>
          }
          attrs.add(attr);
        }
      });
...
&nbsp;
  ...
  connectedCallback() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.constructor.renderer &amp;&amp; typeof this[this.constructor.renderer] === 'function') {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.constructor.hasStyles(this.tagName.toLowerCase())) {
<span class="cstat-no" title="statement not covered" >      this.constructor.adoptStyles(this.shadowRoot ? this.shadowRoot : this, this.tagName.toLowerCase());</span>
    }
...
<span class="cstat-no" title="statement not covered" >      return define;</span>
    ...
    deleteProperty<span class="fstat-no" title="function not covered" >(target, property, descriptor) {</span>
<span class="cstat-no" title="statement not covered" >      const deleted = Reflect.deleteProperty(target, property);</span>
<span class="cstat-no" title="statement not covered" >      onChange(target, property, descriptor);</span>
...
<span class="cstat-no" title="statement not covered" >      !immediate &amp;&amp; Reflect.apply(fn, context, args);</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    const callNow = immediate &amp;&amp; !timeout;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    callNow &amp;&amp; Reflect.apply(fn, context, args);</span>
  };
};
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Sep 14 2018 13:25:41 GMT-0600 (MDT)
</div>
</div>
